"""
Integrate Explainable AI into Web Interface
"""
...
async def home():
    ...
    <head>
        ...
        <style>
            ...
            .upload-area { border: 2px dashed #3498db; padding: 40px; text-align: center; margin: 20px 0; border-radius: 10px; background: #ecf0f1; }
    ...
    <body>
        <div class="container">
            <div class="header">
                ...
                <p>Medical-grade cancer detection with transparent AI reasoning</p>
            </div>
            
            <div class="upload-area" onclick="document.getElementById('fileInput').click()">
                <h3>📤 Upload Medical Image</h3>
                <p>Click to select or drag and drop a medical image</p>
                <input type="file" id="fileInput" accept="image/*" style="display: none;">
            </div>
            
            <div class="loading" id="loading">
                <h3>🔬 Analyzing with Explainable AI...</h3>
                <p>Please wait while our AI analyzes your medical image</p>
            </div>
...
async def health():
    """Health check"""
    return {"status": "Explainable AI is running", "version": "2.0"}
